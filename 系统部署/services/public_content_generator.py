    ...
    "content": {{
        ...
        "images": [
            {{
                ...
                "content": "【画面描述】具体描述画面场景、人物动作、表情等细节\n【文字内容】具体的主标题+副标题内容，要包含用户具体遭遇的问题场景\n【设计要点】画面布局、色调氛围等"
            }},
            {{
                "index": 2,
                "title": "问题展开【具体场景描述】",
                "content": "【画面描述】具体的人物对话、场景细节\n【文字内容】用户遇到的具体问题描述，要有对话或具体场景\n【金句】能引发共鸣的一句话"
            }},
            {{
                "index": 3,
                "title": "问题升级【具体数据或案例】",
                "content": "【画面描述】问题的严重程度描述\n【文字内容】包含具体数字、对比、真实案例场景\n【金句】戳中痛点的警示语"
            }},
            {{
                "index": 4,
                "title": "解决方案【具体方法或产品优势】",
                "content": "【画面描述】问题被解决的场景\n【文字内容】具体解决方案、产品优势、真实用户反馈\n【金句】给用户信心的承诺"
            }},
            {{
                "index": 5,
                "title": "总结引导【行动号召】",
...
【重要】每张图片的内容必须包含：
1. 【画面描述】具体的人物动作、表情、场景细节（如："老板在电脑前眉头紧锁" 而不是 "老板在工作"）
2. 【文字内容】具体的问题描述、对话、真实场景（如："约了朋友品茶，水却迟迟不来" 而不是 "配送不及时"）
   **【特别注意】标题必须包含完整的文字内容，不能只有"技巧1"、"技巧2"这样的占位符！**
   **如果标题是"10个技巧"，那么副标题必须写成"技巧1：XXX、技巧2：XXX..."，或者在文字内容中详细展开每个技巧的具体内容**
3. 【金句】引发共鸣的一句话（如："茶凉了一半" 而不是 "影响体验"）

【反面示例 - 必须避免】
- 主标题：10个技巧
- 文字内容：技巧1、技巧2、技巧3...（没有具体内容）
- 这种内容空洞，读者不知道具体是什么技巧

【正面示例 - 正确写法】
- 主标题：10个泡茶技巧，让茶香更醇厚
- 副标题或文字：
  1. 选对水温：绿茶80°C、红茶95°C、水温不对茶就废了
  2. 醒茶技巧：头泡茶不喝，洗去杂质口感更纯
  3. 茶水比例：1:50，浓淡适中刚刚好
"""
        return prompt
