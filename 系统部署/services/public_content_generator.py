...
**【维度围绕使用者，痛点/目标体现使用者特征】**

**买即用业务（买的人=用的人）：**
- 购买者 = 使用者本人
- 所有维度（年龄、地域、消费阶段）都填本人的
- 痛点/目标：围绕本人的问题

**买用分离业务（买的人≠用的人）：**
- 购买者：宝妈/子女/宠物主人
- 使用者：宝宝/老人/宠物
- **维度都填使用者的**：年龄段是宝宝的年龄，消费阶段是宝宝所处的阶段
- **痛点/目标要体现使用者特征**：
  - 婴儿奶粉：「有1-3岁宝宝的妈妈，宝宝正在断奶期、喝普通奶粉拉肚子」
  - 老人手机：「60-70岁老人，视力下降、不会用智能机」

**buyer_user_relation 字段**：
- 买即用：填「自用」
...
2. 【痛点状态 + 目标·体现使用者特征】
   - pain_point_commonality = 使用者**当前正处于的问题状态**
     ...
     - 买用分离：「2岁宝宝喝奶粉天天拉肚子，不知道哪款适合」
   - goal = 使用者/购买者**希望达成的结果**
     - 买即用：「当场修好、用得放心」
