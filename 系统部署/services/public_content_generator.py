...
{{
    ...
    "content": {{
        ...
        "images": [
            {{
                "index": 1,
                "title": "封面【必须】直接戳痛点：呈现用户困境场景",
                "content": "【画面描述】必须包含具体人物动作+表情+场景细节+对话！\n例如：\"王老板坐在办公室，手里的合同翻到第三页，眉头皱成一团，旁边的老婆小声说：'这份合同要3000块，我们这种小店值不值？'\"\n【文字内容】主标题要直接说出用户的具体问题，副标题要包含场景细节\n例如：\"签一份合同要3000块？我开小店真的需要吗？\"\n【金句】一句让用户心里一紧的话，如：\"不是贵不贵，是值不值\"\n【设计要点】画面布局、色调氛围等"
            }},
            {{
                "index": 2,
                "title": "问题展开【具体场景描述】",
                "content": "【画面描述】必须包含具体对话+场景+数据！\n例如：\"两口子在店里算了笔账：'我们一个月流水才2万，光合同这块就要花1000多...'\n【文字内容】要列出用户具体的担心点，用问句引发共鸣\n例如：\"花了这钱真的能保护我？万一用不上呢？\"\n【金句】如：\"不是心疼钱，是怕花了冤枉钱\"\n【常见顾虑】价格不透明、不知道钱花在哪、不确定值不值"
            }},
            {{
                "index": 3,
                "title": "问题升级【具体数据或案例】",
                "content": "【画面描述】展示具体风险场景，让用户意识到问题的严重性！\n例如：\"张老板因为合同漏洞，被客户索赔8万，但当初律师费才省了500块\"\n【文字内容】用真实数据/案例说话，展示不重视合同的风险\n例如：\"据统计，70%的小微企业都遇到过合同纠纷，平均损失超过5万\"\n【金句】如：\"省了小钱，亏了大钱\"\n【核心观点】专业合同的价值在于规避风险"
            }},
            {{
                "index": 4,
                "title": "解决方案【具体方法或产品优势】",
                "content": "【画面描述】展示问题被解决的场景，对比前后！\n例如：\"王老板签完合同，心里踏实了，和老婆说：'这次放心了，出了问题有人兜底'\n【文字内容】明确告诉用户能得到什么具体保障\n例如：\"3000块包含：合同起草+审核+修改+全年法律咨询，出了问题律师出马\"\n【金句】如：\"花的是小钱，买的是安心\"\n【服务清单】越具体越好"
            }},
            {{
                "index": 5,
                "title": "总结引导【行动号召】",
                "content": "【画面描述】引导行动的具体场景！\n例如：\"两口子打开手机，扫码预约了律师咨询\"\n【文字内容】给出具体的行动指引，降低行动门槛\n例如：\"现在预约，首月咨询免费：点击头像私信我们\"\n【金句】引导评论的开放性问题，如：\"你们签合同一般花多少钱？评论区聊聊\"\n【互动问题】让用户愿意评论"
            }}
        ]
    }}
}}
...
【输出要求 - 必须严格遵守】
1. 每张图的【画面描述】必须≥50字，必须包含：具体人物+具体动作+具体表情+具体对话
2. 每张图的【文字内容】必须包含：主标题（包含具体问题）+副标题（包含具体场景/数据/案例）
3. 每张图的【金句】必须≤15字，必须是口语化、接地气的一句话
4. 禁止输出抽象词如"专业服务""成本焦虑""权益保护"等宽泛概念
5. 所有内容必须具体！具体！具体！重要的事情说三遍
...
{{
    "titles": [
        "你是不是也在纠结：签份合同到底值不值？",
        "99%的小老板都不知道的合同秘密",
        "请律师写份合同要3000块？我这小店值不值？",
        "签合同被坑的3个场景，第3个最冤",
        "合同签不对，亏钱活该"
    ],
    "tags": ["#合同纠纷", "#律师咨询", "#小微企业", "#法律风险", "#开店避坑", "#创业必看"],
    "content": {{
        "topic": "签合同到底值不值？",
        "images": [
            {{
                "index": 1,
                "title": "封面：直接戳痛点",
                "content": "【画面描述】张三坐在办公室里，手里的合同翻到第三页，眉头皱成一团，老婆小声说：'这份合同要3000块律师费，我们这种小餐馆值不值？'（约60字）\n【文字内容】主标题：'请律师写份合同要3000块？我这小餐馆值不值？'\n副标题：'上周刚开业的张老板正在纠结这个问题'\n【金句】：'不是贵不贵，是值不值'\n【设计要点】：暖色调，真实场景"
            }},
            {{
                "index": 2,
                "title": "问题展开：算账",
                "content": "【画面描述】两口子在店里算了笔账：'我们一个月流水才2万，光合同这块就要花1000多...但万一出问题没合同更亏'（约50字）\n【文字内容】主标题：'花了3000块，到底保护了我什么？'\n副标题：'①合同起草500 ②律师审核800 ③全年法律咨询1700'\n【金句】：'不是心疼钱，是怕花了冤枉钱'\n【设计要点】：表格或清单形式"
            }},
            {{
                "index": 3,
                "title": "问题升级：真实案例",
                "content": "【画面描述】张老板因为合同漏洞被客户赖账8万，但当初律师费才省了500块。他蹲在店门口抽烟，老婆在一旁叹气（约55字）\n【文字内容】主标题：'省了500块律师费，亏了8万货款'\n副标题：'据调查，70%的小微企业都遇到过合同纠纷，平均损失超过5万'\n【金句】：'省了小钱，亏了大钱'\n【设计要点】：数据对比醒目"
            }},
            {{
                "index": 4,
                "title": "解决方案：具体清单",
                "content": "【画面描述】张老板签完合同心里踏实了，和老婆说：'这次放心了，出了问题有律师出马兜底'（约45字）\n【文字内容】主标题：'3000块，到底买了什么？'\n副标题：'①合同起草+审核+修改 ②全年法律咨询 ③出了问题律师出马'\n【金句】：'花的是小钱，买的是安心'\n【设计要点】：清单形式，每条具体"
            }},
            {{
                "index": 5,
                "title": "总结引导：行动号召",
                "content": "【画面描述】两口子打开手机扫码预约律师咨询，老婆说：'先问问，反正首月免费'（约35字）\n【文字内容】主标题：'现在预约，律师免费咨询'\n副标题：'点击左下角，回复"合同"领取《餐饮业合同模板》'\n【金句】：'评论区说说，你们签合同一般花多少钱？'\n【设计要点】：互动引导醒目"
            }}
        ]
    }}
}}
