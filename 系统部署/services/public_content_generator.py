...
{{
    ...
    "user_problem_types": "user_problem_types": [
        {{"identity": "久坐办公人群", "problem_base": "前置观望", "problem_category": "体感问题", "problem_type": "身体疲劳/腰酸背痛", "display_name": "久坐办公导致腰酸背痛浑身不舒服", "description": "上了一天班腰酸背痛/久坐导致浑身僵硬不舒服/站久了腿肿/手腕酸痛", "severity": "高", "scenarios": ["下班回家", "周末休息", "连续加班后"], "market_type": "blue_ocean", "market_reason": "细分人群+高体感", "problem_keywords": [{{"keyword": "腰酸背痛浑身不舒服怎么缓解", "type": "blue_ocean", "source": "阶段1B类体感词"}}, {{"keyword": "久坐办公身体累得不行", "type": "blue_ocean", "source": "阶段1B类体感词"}}], "dimension": "阶段1-B类体感问题", "content_direction": "种草型"}},
        {{"identity": "睡眠质量差人群", "problem_base": "前置观望", "problem_category": "体感问题", "problem_type": "睡眠问题/精力差", "display_name": "睡不好白天没精神精力差", "description": "晚上睡不好/失眠多梦/白天没精神/精力跟不上/注意力不集中", "severity": "高", "scenarios": ["工作日", "加班熬夜后", "换季时期"], "market_type": "blue_ocean", "market_reason": "细分人群+高体感", "problem_keywords": [{{"keyword": "睡眠质量差白天没精神怎么办", "type": "blue_ocean", "source": "阶段1B类体感词"}}, {{"keyword": "失眠多梦怎么调理", "type": "blue_ocean", "source": "阶段1B类体感词"}}], "dimension": "阶段1-B类体感问题", "content_direction": "种草型"}},
        {{"identity": "消化不好人群", "problem_base": "前置观望", "problem_category": "体感问题", "problem_type": "肠胃不适/食欲差", "display_name": "肠胃不好吃不下东西没胃口", "description": "肠胃不适/吃不下/没胃口/消化不好/反胃/腹胀", "severity": "高", "scenarios": ["饭后", "换季时", "压力大时"], "market_type": "blue_ocean", "market_reason": "细分人群+高体感", "problem_keywords": [{{"keyword": "肠胃不好吃不下东西怎么办", "type": "blue_ocean", "source": "阶段1B类体感词"}}, {{"keyword": "没胃口不想吃东西怎么调理", "type": "blue_ocean", "source": "阶段1B类体感词"}}], "dimension": "阶段1-B类体感问题", "content_direction": "种草型"}},
        {{"identity": "特定需求人群A", "problem_base": "前置观望", "problem_category": "场景问题", "problem_type": "特定场景下的需求", "display_name": "特定场景需要用到{product_name}", "description": "在某种特定场景下需要{product_name}来解决对应问题", "severity": "高", "scenarios": ["特定场景1", "特定场景2", "特定场景3"], "market_type": "blue_ocean", "market_reason": "细分场景", "problem_keywords": [{{"keyword": "{product_name}在什么情况下用效果最好", "type": "blue_ocean", "source": "阶段1A类场景词"}}, {{"keyword": "什么时候需要用{product_name}", "type": "blue_ocean", "source": "阶段1A类场景词"}}], "dimension": "阶段1-A类场景问题", "content_direction": "种草型"}},
        {{"identity": "特定需求人群B", "problem_base": "前置观望", "problem_category": "场景问题", "problem_type": "换季/特殊时期的需求", "display_name": "换季/特殊时期需要{product_name}", "description": "在换季/特殊时期/特殊情况下需要{product_name}", "severity": "中", "scenarios": ["换季时", "特殊时期", "特殊情况下"], "market_type": "blue_ocean", "market_reason": "细分场景", "problem_keywords": [{{"keyword": "换季时{product_name}怎么用", "type": "blue_ocean", "source": "阶段1A类场景词"}}, {{"keyword": "{product_name}在什么情况下要调整用法", "type": "blue_ocean", "source": "阶段1A类场景词"}}], "dimension": "阶段1-A类场景问题", "content_direction": "种草型"}}
    ], "market_type": "blue_ocean", "market_reason": "细分人群", "problem_keywords": [{{"keyword": "{product_name}用完拉肚子怎么回事", "type": "blue_ocean", "source": "场景痛点词"}}, {{"keyword": "换了{product_name}后腹胀便秘正常吗", "type": "blue_ocean", "source": "长尾转化词"}}], "content_direction": "转化型"}},
        {{"identity": "核心人群B", "problem_base": "前置观望", "problem_category": "皮肤/体表异常", "problem_type": "过敏/不耐反应", "display_name": "使用后皮肤过敏", "description": "具体皮肤表现（如起疹子、红肿、瘙痒、脱皮等）", "severity": "高", "scenarios": ["换季使用", "换新产品", "特定成分"], "market_type": "blue_ocean", "market_reason": "细分人群+高严重性", "problem_keywords": [{{"keyword": "{product_name}用了脸上起疹子怎么回事", "type": "blue_ocean", "source": "场景痛点词"}}, {{"keyword": "换了{product_name}后过敏是成分问题吗", "type": "blue_ocean", "source": "长尾转化词"}}], "content_direction": "转化型"}},
        {{"identity": "易敏体质用户", "problem_base": "前置观望", "problem_category": "过敏/不耐反应", "problem_type": "过敏体质适配", "display_name": "易敏体质担心不适用", "description": "过敏体质担心产品成分导致过敏反应", "severity": "中", "scenarios": ["换季敏感期", "尝试新产品", "特定成分暴露"], "market_type": "blue_ocean", "market_reason": "细分人群", "problem_keywords": [{{"keyword": "过敏体质用{product_name}会过敏吗", "type": "blue_ocean", "source": "场景痛点词"}}, {{"keyword": "{product_name}哪种成分容易引起过敏", "type": "blue_ocean", "source": "长尾转化词"}}], "content_direction": "种草型"}}
    ],
    "buyer_concern_types": [
        {{"identity": "购买者（家长/子女）", "concern_base": "前置观望", "concern_category": "健康/安全担心", "concern_type": "担心症状加重", "display_name": "怕用了症状不改善反而加重", "description": "担心使用者症状没有改善，甚至因为使用产品而加重", "examples": ["孩子用完没效果反而更不舒服", "不知道是不是产品导致的反应"], "market_type": "blue_ocean", "market_reason": "细分顾虑", "problem_keywords": [{{"keyword": "{product_name}用了症状加重是正常反应吗", "type": "blue_ocean", "source": "场景痛点词"}}, {{"keyword": "{product_name}哪种情况下要停用", "type": "blue_ocean", "source": "长尾转化词"}}]}},
        {{"identity": "谨慎型购买者", "concern_base": "前置观望", "concern_category": "风险/安全担心", "concern_type": "担心安全性", "display_name": "怕买错买亏", "description": "不了解产品，担心买错浪费钱或买来不适用", "examples": ["买回来发现不适合怎么办", "不知道怎么判断产品是否合适"], "market_type": "blue_ocean", "market_reason": "细分顾虑", "problem_keywords": [{{"keyword": "{product_name}买回来不合适能退吗", "type": "blue_ocean", "source": "场景痛点词"}}, {{"keyword": "第一次买{product_name}怎么判断适不适合", "type": "blue_ocean", "source": "长尾转化词"}}]}}
    ]
}}
"""
