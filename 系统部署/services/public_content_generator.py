...
【问题类型命名规范】
- problem_type 必须是抽象问题维度（时间精力不足/能力技术不足/特殊人群问题等）
- 禁止写具体症状（腰酸背痛/腿脚不便等）
...
输出示例（阶段1问题5个（A类场景3个+B类体感2个）、阶段2问题2个、阶段3问题1个、付费方顾虑2个，共10个问题）：
{
    ...
    "user_problem_types": [
        {"identity": "做生意的老板/常有待客需求的家庭", "problem_base": "前置观望", "problem_category": "时间问题", "problem_type": "时间精力不足", "display_name": "生意太忙根本没时间做饭", "description": "做生意太忙/加班太晚/根本没时间自己下厨做饭", "severity": "极高", "scenarios": ["下班太晚来不及做饭", "做生意忙得没时间", "加班到很晚饿着肚子"], "market_type": "blue_ocean", "market_reason": "细分场景+极高严重性", "problem_keywords": [{"keyword": "太忙了没时间做饭怎么办", "type": "blue_ocean", "source": "阶段1A类场景词"}, {"keyword": "下班太晚来不及做饭", "type": "blue_ocean", "source": "阶段1A类场景词"}], "dimension": "阶段1-A类场景问题", "content_direction": "种草型"},
        {"identity": "厨艺不佳但常有社交需求的家庭", "problem_base": "前置观望", "problem_category": "能力问题", "problem_type": "能力技术不足", "display_name": "厨艺不行怕在客人面前丢人", "description": "厨艺太差怕做出来不好吃/不会做硬菜/怕招待不周丢面子", "severity": "高", "scenarios": ["家里来客人了不知道做什么菜", "厨艺太差怕被笑话", "想做一桌好菜招待朋友"], "market_type": "blue_ocean", "market_reason": "细分人群+高严重性", "problem_keywords": [{"keyword": "家里来客人了不知道做什么菜", "type": "blue_ocean", "source": "阶段1A类场景词"}, {"keyword": "厨艺不行怕做出来丢人怎么办", "type": "blue_ocean", "source": "阶段1A类场景词"}], "dimension": "阶段1-A类场景问题", "content_direction": "种草型"},
        {"identity": "有老人/特殊人群的家庭", "problem_base": "前置观望", "problem_category": "便利问题", "problem_type": "特殊人群行动受限", "display_name": "家里老人行动不便做饭成了难题", "description": "家里有行动不便的老人/患者，需要人照顾但做饭成了难题", "severity": "极高", "scenarios": ["老人独居没人照顾", "老人进厨房危险", "子女不在家老人生日想给惊喜"], "market_type": "blue_ocean", "market_reason": "细分人群+极高严重性", "problem_keywords": [{"keyword": "老人腿脚不便怎么解决吃饭问题", "type": "blue_ocean", "source": "阶段1A类场景词"}, {"keyword": "独居老人没人做饭怎么办", "type": "blue_ocean", "source": "阶段1A类场景词"}], "dimension": "阶段1-A类场景问题", "content_direction": "种草型"},
        {"identity": "上班族/打工人", "problem_base": "前置观望", "problem_category": "体感问题", "problem_type": "时间精力不足", "display_name": "上了一天班身体疲惫根本不想做饭", "description": "上了一天班身体疲惫/回家根本不想动/更别说做饭了/只想躺着", "severity": "高", "scenarios": ["下班回家累瘫了", "周五加班后", "连续工作多天后"], "market_type": "blue_ocean", "market_reason": "大众人群+高体感", "problem_keywords": [{"keyword": "上了一天班累死了不想做饭怎么办", "type": "blue_ocean", "source": "阶段1B类体感词"}, {"keyword": "下班回家根本不想动更别说做饭", "type": "blue_ocean", "source": "阶段1B类体感词"}], "dimension": "阶段1-B类体感问题", "content_direction": "种草型"},
        {"identity": "家庭主妇/全职妈妈", "problem_base": "前置观望", "problem_category": "体感问题", "problem_type": "时间精力不足", "display_name": "做了一天家务身体已经精疲力竭", "description": "做了一天家务/带孩子/照顾老人已经精疲力竭/实在没精力再下厨/能凑合就凑合", "severity": "高", "scenarios": ["带了一天孩子累坏了", "做完大扫除后", "照顾老人一天后"], "market_type": "blue_ocean", "market_reason": "细分人群+高体感", "problem_keywords": [{"keyword": "做了一天家务累得不行实在不想做饭", "type": "blue_ocean", "source": "阶段1B类体感词"}, {"keyword": "带孩子累了一天根本不想进厨房", "type": "blue_ocean", "source": "阶段1B类体感词"}], "dimension": "阶段1-B类体感问题", "content_direction": "种草型"}
    ],
    "buyer_concern_types": [
        {"identity": "雇主", "concern_base": "前置观望", "concern_category": "场景问题", "concern_type": "方案可达性顾虑", "display_name": "需要用的时候能不能找到人", "description": "需要用的时候临时找不到人/预约不到厨师", "examples": ["周末要请客临时约不到厨师", "提前预约怕时间不确定"], "market_type": "blue_ocean", "market_reason": "细分顾虑", "problem_keywords": [{"keyword": "上门做饭服务能临时预约吗", "type": "blue_ocean", "source": "阶段2方案搜索词"}, {"keyword": "厨师上门做饭怎么预约", "type": "blue_ocean", "source": "阶段2方案搜索词"}]},
        {"identity": "雇主", "concern_base": "使用配套", "concern_category": "信任问题", "concern_type": "安全信任顾虑", "display_name": "陌生人来家里安不安全", "description": "陌生人来家里做饭安全吗/会不会有风险", "examples": ["担心财产安全", "担心人身安全"], "market_type": "blue_ocean", "market_reason": "信任顾虑", "problem_keywords": [{"keyword": "厨师上门做饭安全吗", "type": "blue_ocean", "source": "阶段3购买后担忧词"}, {"keyword": "上门做饭服务有没有监管", "type": "blue_ocean", "source": "阶段3购买后担忧词"}]}
    ]
}
"""
    else:
...
【重要】problem_type 必须是抽象问题维度，禁止写具体症状
...
{{
    "market_analysis": {{
        ...
        "problem_oriented_keywords": [
            {{"keyword": "上了一天班累死了根本不想动", "type": "blue_ocean", "source": "阶段1B类体感词"}},
            {{"keyword": "下班回家根本不想动更别说{product_name}", "type": "blue_ocean", "source": "阶段1B类体感词"}},
            {{"keyword": "身体疲惫精力跟不上", "type": "blue_ocean", "source": "阶段1B类体感词"}},
    ...
    "user_problem_types": [
        {{"identity": "久坐办公人群", "problem_base": "前置观望", "problem_category": "体感问题", "problem_type": "时间精力不足", "display_name": "久坐办公导致身体疲惫精力不足", "description": "上了一天班身体疲惫/久坐导致精力跟不上/回家根本不想动", "severity": "高", "scenarios": ["下班回家", "周末休息", "连续加班后"], "market_type": "blue_ocean", "market_reason": "细分人群+高体感", "problem_keywords": [{{"keyword": "上了一天班累死了不想动怎么办", "type": "blue_ocean", "source": "阶段1B类体感词"}}, {{"keyword": "久坐办公身体疲惫怎么缓解", "type": "blue_ocean", "source": "阶段1B类体感词"}}], "dimension": "阶段1-B类体感问题", "content_direction": "种草型"}},
        {{"identity": "睡眠质量差人群", "problem_base": "前置观望", "problem_category": "体感问题", "problem_type": "身体机能问题", "display_name": "身体机能下降白天没精神", "description": "晚上睡不好/失眠多梦/白天没精神/精力跟不上/注意力不集中", "severity": "高", "scenarios": ["工作日", "加班熬夜后", "换季时期"], "market_type": "blue_ocean", "market_reason": "细分人群+高体感", "problem_keywords": [{{"keyword": "睡眠质量差白天没精神怎么办", "type": "blue_ocean", "source": "阶段1B类体感词"}}, {{"keyword": "失眠多梦怎么调理", "type": "blue_ocean", "source": "阶段1B类体感词"}}], "dimension": "阶段1-B类体感问题", "content_direction": "种草型"}},
        {{"identity": "消化不好人群", "problem_base": "前置观望", "problem_category": "体感问题", "problem_type": "身体机能问题", "display_name": "肠胃消化功能差影响日常生活", "description": "肠胃消化功能差/吃不下/没胃口/精力跟不上", "severity": "高", "scenarios": ["饭后", "换季时", "压力大时"], "market_type": "blue_ocean", "market_reason": "细分人群+高体感", "problem_keywords": [{{"keyword": "肠胃不好吃不下东西怎么办", "type": "blue_ocean", "source": "阶段1B类体感词"}}, {{"keyword": "没胃口不想吃东西怎么调理", "type": "blue_ocean", "source": "阶段1B类体感词"}}], "dimension": "阶段1-B类体感问题", "content_direction": "种草型"}},
        {{"identity": "特定需求人群A", "problem_base": "前置观望", "problem_category": "场景问题", "problem_type": "场景条件受限", "display_name": "特定场景下需要{product_name}", "description": "在某种特定场景下需要{{product_name}}来解决对应问题", "severity": "高", "scenarios": ["特定场景1", "特定场景2", "特定场景3"], "market_type": "blue_ocean", "market_reason": "细分场景", "problem_keywords": [{{"keyword": "{product_name}在什么情况下用效果最好", "type": "blue_ocean", "source": "阶段1A类场景词"}}, {{"keyword": "什么时候需要用{product_name}", "type": "blue_ocean", "source": "阶段1A类场景词"}}], "dimension": "阶段1-A类场景问题", "content_direction": "种草型"}},
        {{"identity": "特定需求人群B", "problem_base": "前置观望", "problem_category": "场景问题", "problem_type": "场景条件受限", "display_name": "换季/特殊时期需要{{product_name}}", "description": "在换季/特殊时期/特殊情况下需要{{product_name}}", "severity": "中", "scenarios": ["换季时", "特殊时期", "特殊情况下"], "market_type": "blue_ocean", "market_reason": "细分场景", "problem_keywords": [{{"keyword": "换季时{{product_name}}怎么用", "type": "blue_ocean", "source": "阶段1A类场景词"}}, {{"keyword": "{product_name}在什么情况下要调整用法", "type": "blue_ocean", "source": "阶段1A类场景词"}}], "dimension": "阶段1-A类场景问题", "content_direction": "种草型"}}
    ],
    "buyer_concern_types": [
        {{"identity": "购买者（家长/子女）", "concern_base": "前置观望", "concern_category": "健康/安全担心", "concern_type": "效果安全顾虑", "display_name": "怕用了症状不改善反而加重", "description": "担心使用者症状没有改善，甚至因为使用产品而加重", "examples": ["孩子用完没效果反而更不舒服", "不知道是不是产品导致的反应"], "market_type": "blue_ocean", "market_reason": "细分顾虑", "problem_keywords": [{{"keyword": "{product_name}用了症状加重是正常反应吗", "type": "blue_ocean", "source": "场景痛点词"}}, {{"keyword": "{product_name}哪种情况下要停用", "type": "blue_ocean", "source": "长尾转化词"}}]}},
        {{"identity": "谨慎型购买者", "concern_base": "前置观望", "concern_category": "风险/安全担心", "concern_type": "适用性顾虑", "display_name": "怕买错买亏", "description": "不了解产品，担心买错浪费钱或买来不适用", "examples": ["买回来发现不适合怎么办", "不知道怎么判断产品是否合适"], "market_type": "blue_ocean", "market_reason": "细分顾虑", "problem_keywords": [{{"keyword": "{product_name}买回来不合适能退吗", "type": "blue_ocean", "source": "场景痛点词"}}, {{"keyword": "第一次买{product_name}怎么判断适不适合", "type": "blue_ocean", "source": "长尾转化词"}}]}}
    ]
}}
"""
