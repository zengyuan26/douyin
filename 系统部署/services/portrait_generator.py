...
⚠️ 【重要】禁止事项：
- 禁止使用具体年龄（如"50岁"、"30岁"、"45岁女性"），使用年龄段（如"30-40岁"、"25-35岁"）
- 禁止使用姓名（如"张先生"、"李女士"、"王老板"），使用泛化描述（如"职场白领"、"家庭主妇"、"企业主"）
- 禁止使用具体数字描述个体（如"3个孩子"、"月入3万"）
- 禁止使用"一个XX"、"有个XX"等个体化描述
- 画像是"一类人"的泛化描述，不是"一个人"的具体刻画
