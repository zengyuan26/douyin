...
3. **可用公式 (formula)**: **必须分析这个简介的实际构成元素**，格式如"要素类型(具体内容)"。**重要：要素类型必须是以下7种之一：身份标签、价值主张、差异化标签、行动号召、价格信息、联系方式、内容要素**。例如：
   ...
   - **特别注意**：
     - 身份标签指：职业背景、学历、职称、专业身份等（如：10年大厂PM、苏黎世大学博士、XX创始人、XX专家、大厂ai实战经验）
     - **价值主张指**：我提供什么价值，粉丝能得到什么（如：干货/技巧/避坑/快乐/成长）。例：每天一个职场技巧｜分享平价护肤｜教你拍照变好看
     - **差异化标签指**：为什么关注你，你和别人不一样在哪。例：只讲真话｜不割韭菜｜0基础也能学｜普通人也能学会
