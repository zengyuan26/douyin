...
{elements_text}
   ...
   **【关键规则】formula 括号内的内容必须是原文中的字，不能添加任何解释性文字！**

   **【重要验证规则】formula 括号内的所有内容组合起来必须等于原始简介 "{bio}"，内容不能多于 bio，不能遗漏任何关键信息！**"""
        else:
   ...
   **【特别注意】**：
     ...
     - 联系方式指：可联系到人的信息（电话、微信/V、邮箱、具体地址、门面地址、商务联系XXX等）
     - 内容要素指：不属于以上6种类型的其他内容，如品牌slogan等"""
